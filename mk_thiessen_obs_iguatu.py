...
nbas = '/home/junior/OneDrive/36160000_elisa.asc'

def pr_thiessen(nbas):
	data = np.loadtxt('data/obs/pr_daily_funceme_19730101_20200824.asc')

	pr = data[:, 3:]
	lon = data[:, 1]
	lat = data[:, 2]
	dates = pd.date_range('19730101','20200824')
...
pr = pr_thiessen(nbas)
pr.to_csv('pr_daily_thiessen_bac_iguatu_36160000_19730101_20200824.csv', header=False, sep=' ')
#print(thi)
